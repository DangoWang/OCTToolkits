...
# UI END
    ...
    def whr_createCamera(self):
        ...
        if not self.whr_exists():
            ...
            print "expression -s \""+newName+".rotateX = noise((time*"+ctl+".frequencyX)+0)*"+ctl+".rangeX;\\n"+newName+".rotateY = noise((time*"+ctl+".frequencyY)+1)*"+ctl+".rangeY;\"  -o a -ae 1 -uc all ;"
            mel.eval("expression -s \""+newName+".rotateX = noise((time*"+ctl+".frequencyX)+0)*"+ctl+".rangeX;\\n"+newName+".rotateY = noise((time*"+ctl+".frequencyY)+1)*"+ctl+".rangeY;\"  -o a -ae 1 -uc all ;")
