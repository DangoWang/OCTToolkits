...
class ImageCalibration(object):
    ...
    def create(self, width=2048, height=2048):
        ...
        # img = cmds.playblast(editorPanelName=cmds.getPanel(withLabel='Persp View'),
        #                      width=width, height=height, percent=100,
        #                      filename=self.image_file, startTime=1, endTime=1, format='image',
        #                      compression='png', quality=100, clearCache=1, offScreen=1,
        #                      viewer=0, showOrnaments=0,
        #                      forceOverwrite=1, framePadding=4)
